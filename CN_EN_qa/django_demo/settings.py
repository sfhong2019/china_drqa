...
SECRET_KEY = '#rw33^h&$9#h)f7&f2cg32&g=3t=g38k+*9bza1h(i%-an!fb5'
...
# SECURE_SSL_REDIRECT = True  # 把http转为https
INSTALLED_APPS = [
    ...
    'demo_app.apps.DemoAppConfig', # 注册子应用denmo_app
    'corsheaders', # 允许跨域请求
    # 'sslserver', #把http转为https
    # 'werkzeug_debugger_runserver', #把http转为https
    # 'django_extensions', #把http转为https
]
